...
class AllJoints:
    ...
    def __init__(self,joint_name_lst):
        self.jta = actionlib.SimpleActionClient('/quadruped_2/joint_trajectory_controller/follow_joint_trajectory', FollowJointTrajectoryAction)
        rospy.loginfo('Waiting for joint trajectory action')
        self.jta.wait_for_server()
        rospy.loginfo('Found joint trajectory action!')
        self.jtp = rospy.Publisher('/quadruped_2/joint_trajectory_controller/command',JointTrajectory,queue_size=1)
...
# quadruped_2 environment adapter
class QuadrupedEnvironment:
    
    # environment configuration parameters
    def __init__(self):
        rospy.init_node('joint_position_node_2')
        self.nb_joints = 12
        self.nb_links = 13
        self.state_shape = (self.nb_joints * 2 + 4 + 3 + 3,) #joint states + orientation
        self.action_shape = (self.nb_joints,)
        self.link_name_lst = ['quadruped_2::base_link',
                             'quadruped_2::front_right_leg1', 'quadruped_2::front_right_leg2', 'quadruped_2::front_right_leg3',
                             'quadruped_2::front_left_leg1', 'quadruped_2::front_left_leg2', 'quadruped_2::front_left_leg3',
                             'quadruped_2::back_right_leg1', 'quadruped_2::back_right_leg2', 'quadruped_2::back_right_leg3',
                             'quadruped_2::back_left_leg1', 'quadruped_2::back_left_leg2', 'quadruped_2::back_left_leg3']
        ...
        self.model_state_req.model_state.model_name = 'quadruped_2'
        ...
        self.get_model_state_req.model_name = 'quadruped_2'
        ...
        self.joint_state_subscriber = rospy.Subscriber('/quadruped_2/joint_states',JointState,
                                                       self.joint_state_subscriber_callback)
        self.orientation = np.zeros(4)
        self.angular_vel = np.zeros(3)
        self.linear_acc = np.zeros(3)
        self.imu_subscriber = rospy.Subscriber('/quadruped_2/imu',Imu,
